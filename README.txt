...
constantes WWW_PATH et HTTP_PATH de la classe PathHandler (peu après la 800e ligne de ce fichier) 
pour y placer respectivement le chemin absolu de votre dossier www/ (ou équivalent) sur sa machine 
hôte et la racine de toutes vos URLs.

Dans default.js, éditez la variable .httpPath dans DefaultLib pour y placer à nouveau la racine de 
toutes vos URLs.
