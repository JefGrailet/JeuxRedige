...
/**
* This library is designed to handle keywords in general, i.e., to display them as HTML code (with 
* the right JS code to interact with them) and to compare sets of keywords together.
*/
...
class Keywords
{
   ...
   */
   ...
   /*
   * Turns an array of keywords into HTML code displaying them with delete buttons. In addition to 
   * the array of keywords, one must provide the JavaScript function to call for deletion.
   *
   * @param string $arr[]       An array of keywords to display
