...
/**
* This class is a popular solution for decoding GIFs. I do not own it, neither coded it. The sole 
* purpose of having this class is to be able to properly resize GIFs.
*
* I downloaded the code here:
* http://www.phpclasses.org/package/7353-PHP-Resize-animations-in-files-of-the-GIF-format.html#view_files/files/38637
* (a free registration on PHPClasses.org is needed to view it)
*/
