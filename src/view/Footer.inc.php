...
?>
         ...
         <p>
            ...
            <a href="https://github.com/JefGrailet/JeuxRedigeBE" target="blank" class="iconLink"><i class="icon-ext_github" style="font-size: 24px;" title="Code source sur GitHub"></i></a> 
